...
const Patient = async ({ id }: { id: string }) => {
  ...
  const { patient, vitals, comments, histories, patientComorbidities, patientDisabilities } = await getPatientByIdWithVitalsAndCommentsAndHistoriesAndPatientComorbiditiesAndPatientDisabilities(id);
  ...
  return (
    <Suspense fallback={<Loading />}>
      ...
      <div className="relative mt-8 mx-4">
        <h3 className="text-xl font-medium mb-4">{patient.name}&apos;s Vitals</h3>
        <VitalList
          patients={[]}
      ...
      <div className="relative mt-8 mx-4">
        <h3 className="text-xl font-medium mb-4">{patient.name}&apos;s Histories</h3>
        <HistoryList
          patients={[]}
          patientId={patient.id}
          histories={histories}
      ...
      <div className="relative mt-8 mx-4">
        <h3 className="text-xl font-medium mb-4">{patient.name}&apos;s Patient Comorbidities</h3>
      ...
      <div className="relative mt-8 mx-4">
        <h3 className="text-xl font-medium mb-4">{patient.name}&apos;s Patient Disabilities</h3>
